namespace SistemaContrtoleEstoque.Model
{
    ...
    public class SistemaContext : DbContext
    {
        ...
        // 'SistemaContrtoleEstoque.Model.SistemaContext' database on your LocalDb instance. 
        // 
        ...
        // on configuring and using a Code First model, see http://go.microsoft.com/fwlink/?LinkId=390109.
         ...
         public virtual DbSet<Usuario> Usuarios { get; set; } // carregando usuários
         public virtual DbSet<Estoque> Estoques { get; set; } // Carrega o Estoque
    }
